...
@Component({
  selector: 'app-ingenome',
  templateUrl: './ingenome.component.html',
  styleUrls: ['./ingenome.component.css']
})
export class IngenomeComponent implements OnInit {
  ...
  constructor(
  	...
  	this.projectId = this.route.snapshot.params.projectId;
        ...
        this.kpi_titles = {
            ...
            'cva': 'Value Assessment (Entity A)',
            'eva': 'Value Assessment (Entity B)',
